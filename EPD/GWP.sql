WITH DATA1 as (SELECT REC_ID,
               ...
               WHERE COMPANY_CODE = 'TM'
                 AND BATCH_NUMBER = '20240120241220250213YS'),
     ...
     MATRIX_INV AS (SELECT PROC_KEY,
                    ...
                    WHERE BATCH_NUMBER = '20240120241220250213YS'
                      AND COMPANY_CODE = 'TM'
                      AND INV = 'Y'
                      AND UNIT_COST != 0),
     ...
     RESULT1 AS (SELECT HEX(RAND())              AS REC_ID,
                        '20240120241220250213YS' AS BATCH_NUMBER,
                        'TM'                     AS COMPANY_CODE,
                        A.PROC_KEY,
                        A.PROC_CODE,
                        A.PROC_NAME,
...
WITH DATA1 as (SELECT REC_ID,
               ...
               WHERE COMPANY_CODE = 'TM'
                 AND BATCH_NUMBER = '20240120241220250213YS'
                 AND REC_ID IN ('CA48332465A4D93F', '09CE3D8A04E7BE3F', 'E2C028277160D43F')),
...
WHERE YEAR = '2025'
  AND LCI_ELEMENT_NAME IN ('全球变暖潜力(GWP100):合计', '全球变暖潜力(GWP100):合计');
...
where company_code = 'RG'
  AND BATCH_NUMBER = '20250120250420250522YS';
