create table BG00MAC102.T_ADS_FACT_LCA_SUBCLASS_RESULT_DIST_PARALLEL
(
    REC_ID                VARCHAR(64),
...
comment on table BG00MAC102.T_ADS_FACT_LCA_SUBCLASS_RESULT_DIST_PARALLEL is 'LCA细类中间分布结果平行结转方法';
