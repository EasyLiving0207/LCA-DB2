CREATE OR REPLACE PROCEDURE BG00MAC102.P_ADS_FACT_LCA_SUBCLASS_SEQ_CALC_GWP(
...
--     DECLARE CONTINUE HANDLER FOR NOT FOUND SET DONE = 1;
    ...
    SET V_MAX_BATCH_NUMBER = V_MAIN_BATCH_NUMBER;
           ...
           FROM ' || V_TMP_SCHEMA || '.' || V_TMP_TAB || '_UUID A
               ...
               WHERE YEAR = ''' || V_FACTOR_YEAR || '''
                 AND LCI_ELEMENT_NAME IN (''全球变暖潜力(GWP100):合计'',
                                          ''全球变暖潜力(GWP100):化石能源'',
                                          ''全球变暖潜力(GWP100):生物质'',
                                          ''全球变暖潜力(GWP100):土地利用和土地用途改变'')) B ON A.UUID = B.UUID
     ';
