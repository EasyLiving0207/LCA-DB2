CREATE OR REPLACE PROCEDURE BG00MAC102.P_ADS_FACT_LCA_SUBCLASS_READ_ACTI_DATA(IN V_PCR VARCHAR(6),
...
BEGIN
    ...
    DECLARE V_FILTER_ESC VARCHAR(1200);

    SET V_FILTER_ESC = COALESCE(V_SUBCLASS_FILTER_CONDITION, '');
